...
abstract class Builder
{
    ...
    abstract public function upsert(array $data, string $targetColumn, array $excludedColumns = []): bool;
    abstract public function upsertBulk(array $data, string $targetColumn, array $excludedColumns = []): bool;
